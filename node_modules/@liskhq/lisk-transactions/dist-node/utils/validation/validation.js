...
exports.isNumberString = exports.isGreaterThanMaxTransactionId = exports.isGreaterThanMaxTransactionAmount = exports.validateAddress = exports.validateKeysgroup = exports.validatePublicKeys = exports.checkPublicKeysForDuplicates = exports.validatePublicKey = undefined;
...
var validatePublicKey = exports.validatePublicKey = function validatePublicKey(publicKey) {
	var publicKeyBuffer = _liskCryptography2.default.hexToBuffer(publicKey);
...
var isGreaterThanMaxTransactionAmount = exports.isGreaterThanMaxTransactionAmount = function isGreaterThanMaxTransactionAmount(amount) {
	return amount.cmp(_liskConstants.MAX_TRANSACTION_AMOUNT) > 0;
};

var isGreaterThanMaxTransactionId = exports.isGreaterThanMaxTransactionId = function isGreaterThanMaxTransactionId(id) {
	return id.cmp(_liskConstants.MAX_TRANSACTION_ID) > 0;
};

var isNumberString = exports.isNumberString = function isNumberString(str) {
