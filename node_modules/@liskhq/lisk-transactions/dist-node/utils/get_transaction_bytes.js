...
exports.checkTransaction = exports.getAssetBytes = exports.getAssetDataForTransferOutOfDappTransaction = exports.getAssetDataForTransferIntoDappTransaction = exports.getAssetDataForCreateDappTransaction = exports.getAssetDataForRegisterMultisignatureAccountTransaction = exports.getAssetDataForCastVotesTransaction = exports.getAssetDataForRegisterDelegateTransaction = exports.getAssetDataForRegisterSecondSignatureTransaction = exports.getAssetDataForTransferTransaction = exports.checkRequiredFields = exports.isValidValue = undefined;
...
var _liskCryptography = require('@liskhq/lisk-cryptography');

var _liskCryptography2 = _interopRequireDefault(_liskCryptography);
...
var getAssetDataForRegisterSecondSignatureTransaction = exports.getAssetDataForRegisterSecondSignatureTransaction = function getAssetDataForRegisterSecondSignatureTransaction(_ref2) {
	...
	return _liskCryptography2.default.hexToBuffer(publicKey);
};
...
var checkTransaction = exports.checkTransaction = function checkTransaction(transaction) {
	...
	if (data && data.length > _constants.BYTESIZES.DATA) {
		throw new Error('Transaction asset data exceeds size of ' + _constants.BYTESIZES.DATA + '.');
	}
	return true;
};
...
var getTransactionBytes = function getTransactionBytes(transaction) {
	...
	var transactionType = Buffer.alloc(_constants.BYTESIZES.TYPE, type);
	var transactionTimestamp = Buffer.alloc(_constants.BYTESIZES.TIMESTAMP);
	transactionTimestamp.writeIntLE(timestamp, 0, _constants.BYTESIZES.TIMESTAMP);

	var transactionSenderPublicKey = _liskCryptography2.default.hexToBuffer(senderPublicKey);
	var transactionRequesterPublicKey = requesterPublicKey ? _liskCryptography2.default.hexToBuffer(requesterPublicKey) : Buffer.alloc(0);

	var transactionRecipientID = recipientId ? _liskCryptography2.default.bigNumberToBuffer(recipientId.slice(0, -1), _constants.BYTESIZES.RECIPIENT_ID) : Buffer.alloc(_constants.BYTESIZES.RECIPIENT_ID);
	...
	var transactionAmount = amountBigNum.toBuffer({
		endian: 'little',
		size: _constants.BYTESIZES.AMOUNT
	});

	var transactionAssetData = getAssetBytes(transaction);

	var transactionSignature = signature ? _liskCryptography2.default.hexToBuffer(signature) : Buffer.alloc(0);

	var transactionSecondSignature = signSignature ? _liskCryptography2.default.hexToBuffer(signSignature) : Buffer.alloc(0);
